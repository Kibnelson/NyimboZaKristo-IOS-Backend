...
jQuery.fn.themeswitcher = function(settings){
	...
	var switcherpane = $('<div class="jquery-ui-themeswitcher"><div id="themeGallery">	<ul>			<li><a href="css/jquery-ui.css">				<span class="themeName">Pepper Grinder</span>				</a></li>				</ul></div></div>').find('div').removeAttr('id');
	...
	jQuery.fn.spShow = function(){ $(this).css({top: button.offset().top + options.buttonHeight + 6, left: button.offset().left}).slideDown(50); button.css(button_active); options.onOpen(); }
	jQuery.fn.spHide = function(){ $(this).slideUp(50, function(){options.onClose();}); button.css(button_default); }
